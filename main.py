...
entryField=Entry(root, font=('ariel', 20, 'bold'), bg='dodgerblue3', fg='white', bd=10, relief=SUNKEN, width=30)
...
for i in button_text_list:
    button=Button(root, width=5, height=2,bd=2,relief=SUNKEN, text=i, bg='dodgerblue', fg='white', font=('ariel',18, 'bold'), activebackground='dodgerblue3',command=lambda button=i: click(button))
